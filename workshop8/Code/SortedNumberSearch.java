...
public class SortedNumberSearch {
...
//	        System.out.println("n =" + n);	        
	        ...
	        for(int i = 0; i < 100; i++) {
	        	...
	        	Integer searchNum = random.nextInt(Integer.MAX_VALUE);
		        for(int j = 0 ; j < n ; j ++) {
		            testData.add(j);
	        	}
